"""
This code is from Giannisnik's https://github.com/giannisnik/som
====MINOR ALTERATIONS MADE by me=====
    ...
    def map_vects(self, input_vects):
        ...
        for vect in input_vects:
            min_index = min([i for i in range(len(self.weights))],
                            ...
                            key=lambda x: np.linalg.norm((vect-self.weights[x]).detach())) ##ADDED DETACH
